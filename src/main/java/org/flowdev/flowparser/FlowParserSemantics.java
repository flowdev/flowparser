...
import org.flowdev.flowparser.rawdata.RawBool;
import org.flowdev.flowparser.rawdata.RawConfig;
import org.flowdev.flowparser.rawdata.RawConnectionChain;
import org.flowdev.flowparser.rawdata.RawConnectionPart;
import org.flowdev.flowparser.rawdata.RawCreator;
import org.flowdev.flowparser.rawdata.RawCreatorType;
import org.flowdev.flowparser.rawdata.RawDataPath;
...
import org.flowdev.flowparser.rawdata.RawGetterType;
import org.flowdev.flowparser.rawdata.RawInt;
...
import org.flowdev.flowparser.rawdata.RawSetter;
import org.flowdev.flowparser.rawdata.RawSetterType;
import org.flowdev.flowparser.rawdata.RawStr;
...
class FlowParserSemantics extends SemanticsBase {
	...
	if (firstPart.operationName == null) {
		...
		firstPart.inPort.name = (secondPart.inPort != null) ? secondPart.inPort.name
			: "in";
	    }
	}
	...
	if (lastPart.operationName == null) {
		...
		lastPart.outPort.name = (preLastPart.outPort != null) ? preLastPart.outPort.name
			: "out";
	    }
	} else {
	...
	return part.operationName != null && part.outPort != null
		&& part.outPort.name != null
